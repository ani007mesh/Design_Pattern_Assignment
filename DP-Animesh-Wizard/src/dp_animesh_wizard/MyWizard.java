...
public class MyWizard extends Wizard {
	...
	public boolean performFinish() {
		...
		System.out.println("INSERT INTO DPASSIGN values (default, '"+t.getName()+"', '"+t.getFrom()+"', '"+t.getTo()+"','"+t.getVia()+"', '"+t.getAgent()+"', '"+t.getDate()+"');");
		String query = "INSERT INTO DPASSIGN values (default, '"+t.getName()+"', '"+t.getFrom()+"', '"+t.getTo()+"','"+t.getVia()+"', '"+t.getAgent()+"', '"+t.getDate()+"');";
